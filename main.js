let map = L.map('map').setView([42.2776005, 0.9486118], 7);
...
console.log(Array.isArray(bestPath))

let bestPathArray = Object.values(bestPath);
console.log(bestPath);

console.log(bestPathArray);

console.log(Array.isArray(bestPathArray))
...
var paths = [bestPathArray];
console.log(JSON.stringify(bestPathArray));
console.log(paths);
